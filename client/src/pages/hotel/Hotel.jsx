...
import Resorve from "../../componsnts/resorv/Resorve";
...
const Hotel = () => {
    ...
    //     const differenceInDays = dayDifference(dates[0].endDate, dates[0].startDate);
    //     // console.log("Difference in days:", differenceInDays);
    // } else {
    //     // console.log("Dates are not properly set.");
    // }
    ...
    return (
        <div>
            ...
            {loading ? "Loading..." : <div className="hotelContainer">
                ...
                <div className="hotelWrapper">
                    ...
                    <span className="hotelPriceHighlight">
                        Book a stay over ${data.chapestPrice} at this property and get a free airport taxi
                    </span>
                    ...
                    <div className="hotelDetails">
                        ...
                        <div className="hotelDetailsPrice">
                            ...
                            <h2>
                                <b>${days * data.chapestPrice * options.room}</b> ({days} nights)
                            </h2>
            ...
            {openModal && <Resorve setOpen={setOpenModal} hotelId={id} />}
        </div>
    );
};
