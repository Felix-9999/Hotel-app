...
const Resorve = ({ setOpen, hotelId }) => {
    ...
    const isAvailable = ((rumNumber) => {
        const isFount = rumNumber.unavailableDates.some(date => {
